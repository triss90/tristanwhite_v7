jQuery(document).ready(function($) {
   ...
   'use strict';
    ...
    $('#countdown').countdown({until: new Date(2016, 6-1, 15)}); // enter event day
...
$(window).load(function(){
    ...
    var myOptions = {
        zoom: 14,
        center: new google.maps.LatLng(56.114916, 10.178393), //change the coordinates
    ...
    marker = new google.maps.Marker({
        map: map,
        position: new google.maps.LatLng(56.114916, 10.178393) //change the coordinates
    });
    infowindow = new google.maps.InfoWindow({
        content: "<b>Holme-Rundhøj Festuge</b>"  //add your address
    });
